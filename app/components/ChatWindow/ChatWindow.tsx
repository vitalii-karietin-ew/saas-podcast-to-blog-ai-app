...
import { IntermediateStep } from "../IntermediateStep/IntermediateStep";
...
export function ChatWindow(props: {
  ...
  return (
    <div style={{ maxHeight: 500 }}className={`flex flex-col items-center p-4 md:p-8 rounded grow overflow-hidden ${(messages.length > 0 ? "border" : "")}`}>
